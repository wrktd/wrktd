...
export default function HowItWorksSection() {
  return (
    <section id="how-it-works" className="grain py-28 px-6 bg-ink overflow-hidden">
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-0">
          {STEPS.map((step, i) => (
            <div
              ...
              className="relative"
              style={{
                borderLeft: i === 0 ? "1px solid rgba(184,154,78,0.2)" : "none",
                borderRight: "1px solid rgba(184,154,78,0.2)",
                padding: "0 2.5rem 0 2.5rem",
              }}
            >
              {/* Step number */}
              <div
                className="font-display font-light mb-8 leading-none select-none"
                style={{
                  fontSize: "clamp(4rem, 8vw, 7rem)",
                  color: "rgba(184,154,78,0.12)",
                  lineHeight: 1,
                }}
              >
                {step.n}
              ...
              <span className="label text-gold/50 block mb-3">{step.time}</span>
              <h3
        ...
        {/* Summary bar */}
        <div
          className="mt-20 py-8 px-10 flex flex-col md:flex-row items-center md:items-start gap-6 md:gap-16"
          style={{ borderTop: "1px solid rgba(184,154,78,0.15)" }}
        >
          <p className="label text-gold/60 flex-shrink-0">Client-facing language</p>
          <p
            className="font-display font-light text-lg md:text-xl"
            style={{ color: "rgba(250,247,242,0.5)", lineHeight: 1.5 }}
          >
